  ...
  return (
    ...
    >
      ...
      <div className="absolute inset-0 pointer-events-none overflow-hidden">
        ...
        {/* Animated Orbs */}
        <div className="absolute -top-[20%] -right-[10%] h-[800px] w-[800px] rounded-full bg-teal-400/20 dark:bg-teal-500/20 blur-[120px] animate-pulse" style={{ animationDuration: "8000ms", willChange: "opacity" }} />
        <div className="absolute top-[40%] -left-[15%] h-[600px] w-[600px] rounded-full bg-rose-400/20 dark:bg-rose-500/15 blur-[120px] animate-pulse" style={{ animationDuration: "10000ms", willChange: "opacity" }} />

  ...
  return (
    ...
    >
      ...
      <div className="absolute inset-0 pointer-events-none overflow-hidden">
        <div className="absolute -top-[40%] -right-[20%] h-[900px] w-[900px] rounded-full bg-teal-50/60 dark:bg-teal-500/10 blur-[100px]" />
        <div className="absolute -bottom-[30%] -left-[15%] h-[600px] w-[600px] rounded-full bg-rose-50/40 dark:bg-rose-500/8 blur-[100px]" />
      </div>
      ...
      <div className="relative z-10 mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        <div className="grid min-h-screen items-center gap-12 py-20 lg:grid-cols-[1.1fr_0.9fr] lg:gap-20">
          ...
          <div className="flex flex-col justify-center space-y-8">
            {/* Badge */}
            <div className="inline-flex w-fit items-center gap-2 rounded-full border border-teal-200/60 dark:border-teal-700/60 bg-white/80 dark:bg-slate-800/80 px-4 py-2 shadow-sm backdrop-blur-sm">
              <span className="flex h-1.5 w-1.5 rounded-full bg-teal-500 dark:bg-teal-400 animate-pulse" />
            ...
            <div className="space-y-5">
              <h1 className="text-[2.75rem] font-extrabold leading-[1.08] tracking-tight text-slate-900 dark:text-slate-100 sm:text-6xl lg:text-[4.25rem]">
                <span className="block">{t("title_top")}</span>
                <span className="block text-teal-600 dark:text-teal-400">
                  {t("title_bottom")}
                </span>
              </h1>
              <p className="max-w-lg text-lg leading-relaxed text-slate-600 dark:text-slate-300 sm:text-xl">
                {t("tagline")}
              </p>
            </div>
            ...
            <div className="flex flex-col gap-3 sm:flex-row sm:items-center">
              ...
              <Button
                ...
                className="h-13 rounded-full px-8 text-base font-medium text-slate-700 dark:text-slate-300 transition-colors hover:bg-slate-100 dark:hover:bg-slate-800 hover:text-slate-900 dark:hover:text-slate-100 cursor-pointer"
              >
                {t("cta_secondary")}
          ...
          <div className="relative lg:h-[640px]">
            <div className="relative h-[480px] w-full overflow-hidden rounded-3xl bg-slate-100 dark:bg-slate-800 shadow-xl ring-1 ring-black/5 dark:ring-slate-700/50 lg:h-full">
              <Image
